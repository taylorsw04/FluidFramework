# Shared Tree Project Architecture

This document covers the internal structure of the Shared Tree DDS.
Herein the user of this package is called "the application".
